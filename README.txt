...
- Para simular o módulo principal, ele deve ser chamado e suas entradas devem ser inseridas. Em seguida, enquanto não houver o fim do jogo, ou seja, enquanto nenhum dos jogadores chegar no fim do caminho que deve ser percorrido por ele, o módulo principal executará as chamadas dos módulos que regem o comportamento do circuito e dos leds do tabuleiro a cada vez que os jogadores apertam um botão.
